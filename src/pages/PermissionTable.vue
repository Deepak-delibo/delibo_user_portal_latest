          ...
          <tr v-for="(row, index) in tableData" :key="index">
            ...
            <td class="text-left">
              ...
              <div class="text-primary q-gutter-sm">
                ...
                >
                  <q-tooltip transition-show="flip-right" transition-hide="flip-left">View</q-tooltip>
                </q-btn>

                <q-btn flat dense icon="edit" color="primary" size="sm">
                  <q-tooltip transition-show="scale" transition-hide="scale">Edit</q-tooltip>
                </q-btn>

                <q-btn flat dense icon="delete" color="primary" size="sm" @click="showAlert">
                  <q-tooltip transition-show="rotate" transition-hide="rotate">Delete</q-tooltip>
                </q-btn>
              </div>
            </td>
          </tr>
        ...
        <q-card-section>
          <div class>
            <div class="text-primary flex justify-end">
              ...
              <q-btn flat dense icon="delete" color="primary" @click="showAlert">
                <q-tooltip transition-show="rotate" transition-hide="rotate">Delete</q-tooltip>
              </q-btn>
            </div>
